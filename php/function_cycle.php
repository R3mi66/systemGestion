...
<?php
	...
	function mensuel_station($intervention, $station, $ouvrage, $year)
	{
		...
		$base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Janvier - ' . $ouvrage . '\', \'' . $year . '-01-01 00:00:00\', \'' . $year . '-01-31 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Février - ' . $ouvrage . '\', \'' . $year . '-02-01 00:00:00\', \'' . $year . '-02-28 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Mars - ' . $ouvrage . '\', \'' . $year . '-03-01 00:00:00\', \'' . $year . '-03-31 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Avril - ' . $ouvrage . '\', \'' . $year . '-04-01 00:00:00\', \'' . $year . '-04-30 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Mai - ' . $ouvrage . '\', \'' . $year . '-05-01 00:00:00\', \'' . $year . '-05-31 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Juin - ' . $ouvrage . '\', \'' . $year . '-06-01 00:00:00\', \'' . $year . '-06-30 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Juillet - ' . $ouvrage . '\', \'' . $year . '-07-01 00:00:00\', \'' . $year . '-07-31 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Aout - ' . $ouvrage . '\', \'' . $year . '-08-01 00:00:00\', \'' . $year . '-08-31 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Septembre - ' . $ouvrage . '\', \'' . $year . '-09-01 00:00:00\', \'' . $year . '-09-30 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Octobre - ' . $ouvrage . '\', \'' . $year . '-10-01 00:00:00\', \'' . $year . '-10-31 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Novembre - ' . $ouvrage . '\', \'' . $year . '-11-01 00:00:00\', \'' . $year . '-11-30 23:59:59\', NULL, NULL)');
        $base->query('INSERT INTO tache_' . $year . ' VALUES (NULL, \'' . $intervention . ' ' . $station . ' - Mois de Decembre - ' . $ouvrage . '\', \'' . $year . '-12-01 00:00:00\', \'' . $year . '-12-31 23:59:59\', NULL, NULL)');
	}
