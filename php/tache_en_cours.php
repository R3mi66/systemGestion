					...
					while ( $donnees = $reponse->fetch() )
					{
						echo '<tr>';
							if ($donnees['datemaxtache'] < $now)
							{
								...
								echo '<td><a class="a" href=\'?idtache=' . $donnees['idtache'] . '\' onclick="return confirm(\'Etes vous sûre de vouloir valider cette intervention \');">' . htmlspecialchars($donnees['nomtache']) . '</a></td>';
							}
